 ...
 */
public class NewEncryptionAESRSA {
...
//        private static String privateKey = "";
	 ...
	 */
	public NewEncryptionAESRSA() throws GeneralSecurityException {
	...
	private void copy(InputStream is, OutputStream os) throws IOException {
       ...
       public static void main(String[] args) throws GeneralSecurityException, IOException {
        ...
        try {
            ...
            NewEncryptionAESRSA secure = null;
            try {
                secure = new NewEncryptionAESRSA();
            } catch (GeneralSecurityException ex) {
                Logger.getLogger(NewEncryptionAESRSA.class.getName()).log(Level.SEVERE, null, ex);
            }
            // to encrypt a file
            secure.makeKey();
